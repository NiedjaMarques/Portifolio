...
const NavLinks = ({ onNavigate }) => (
    <div className='hidden sm:block'>
        <div className='ml-10 flex items-baseline space-x-4 '>
            <a href="#" onClick={() => onNavigate('home')} className="rounded-md px-3 py-2 text-sm font-medium text-[#FF4A00] hover:bg-[#252024] hover:text-white" aria-current="page">Home</a>
