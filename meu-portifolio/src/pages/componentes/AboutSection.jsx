function About(){
    return(
        <>
            <section className="bg-[#562300] flex flex-col items-start px-4 mx-auto justify-center pt-20">

                <h1 className="text-3xl sm:text-4xl font-bold text-[#D5BAA6] pt-4">
                    Sobre mim
                </h1>

                <p className="sm:max-w-screen-lg py-5 px-3 lg:px-8 font-medium text-[#D5BAA6]">
